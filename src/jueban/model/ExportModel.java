...
public class ExportModel extends AbstractTableModel{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5054802530142554491L;
	public static ArrayList<Export> array;
	...
	public ExportModel(CommodityModel cmodel,CustomerModel cusmodel,ImportModel imodel,Clink clink){
	 ...
	 * @throws IOException 
	 */
	public boolean del(String customername,String commodityname,String commoditysize,int buynum,int buyprice) throws IOException{
